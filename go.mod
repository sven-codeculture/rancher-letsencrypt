module github.com/vostronet/rancher-letsencrypt
...
require (
	...
	github.com/vostronet/go-rancher/v2 v2.0.0-20190629163341-0d52644bdc9d
	github.com/vostronet/lego v2.6.4+incompatible
